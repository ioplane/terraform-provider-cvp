...
type Entities struct {
	...
	//
	// ```
	Values        map[string]*Entity `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type InputFields struct {
	...
	Values        map[string]*InputField `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AutofillArgumentProviders struct {
	...
	Values        map[string]*AutofillArgumentProvider `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_arista_studio_v1_studio_proto_rawDesc = "" +
	"\n" +
	"\x1darista/studio.v1/studio.proto\x12\x10arista.studio.v1\x1a\x14fmp/extensions.proto\x1a\x12fmp/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x8d\x01\n" +
	"\tStudioKey\x129\n" +
	"\tstudio_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bstudioId\x12?\n" +
	"\fworkspace_id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\vworkspaceId:\x04\x80\x8e\x19\x01\"\xf4\x02\n" +
	"\fStudioConfig\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.StudioKeyR\x03key\x122\n" +
	"\x06remove\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06remove\x12?\n" +
	...
	"\btemplate\x18\x05 \x01(\v2\x1a.arista.studio.v1.TemplateR\btemplate\x12@\n" +
	"\finput_schema\x18\x06 \x01(\v2\x1d.arista.studio.v1.InputSchemaR\vinputSchema:\x06\xfa\x8d\x19\x02rw\"\xad\x03\n" +
	"\rStudioSummary\x12-\n" +
	...
	"\timmutable\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\timmutable\x126\n" +
	"\bentities\x18\x05 \x01(\v2\x1a.arista.studio.v1.EntitiesR\bentities\x121\n" +
	"\x06in_use\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x05inUse\x12?\n" +
	"\ffrom_package\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vfromPackage:\x06\xfa\x8d\x19\x02ro\"\x8b\x02\n" +
	"\x06Entity\x12=\n" +
	"\ventity_type\x18\x01 \x01(\x0e2\x1c.arista.studio.v1.EntityTypeR\n" +
	"entityType\x12D\n" +
	"\x10last_modified_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x0elastModifiedAt\x12F\n" +
	"\x10last_modified_by\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x0elastModifiedBy\x124\n" +
	"\aremoved\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\aremoved\"\x9f\x01\n" +
	"\bEntities\x12>\n" +
	"\x06values\x18\x01 \x03(\v2&.arista.studio.v1.Entities.ValuesEntryR\x06values\x1aS\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\v2\x18.arista.studio.v1.EntityR\x05value:\x028\x01\"\x87\x05\n" +
	"\x06Studio\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.StudioKeyR\x03key\x129\n" +
	"\n" +
	...
	"\x10last_modified_by\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x0elastModifiedBy\x12?\n" +
	"\fdisplay_name\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\vdisplayName\x12>\n" +
	"\vdescription\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vdescription\x126\n" +
	"\btemplate\x18\b \x01(\v2\x1a.arista.studio.v1.TemplateR\btemplate\x12@\n" +
	"\finput_schema\x18\t \x01(\v2\x1d.arista.studio.v1.InputSchemaR\vinputSchema\x12?\n" +
	"\ffrom_package\x18\v \x01(\v2\x1c.google.protobuf.StringValueR\vfromPackage:\x06\xfa\x8d\x19\x02roJ\x04\b\n" +
	"\x10\v\"\xb3\x01\n" +
	"\x12AssignedTagsConfig\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.StudioKeyR\x03key\x122\n" +
	"\x06remove\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06remove\x122\n" +
	"\x05query\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x05query:\x06\xfa\x8d\x19\x02rw\"\xff\x02\n" +
	"\fAssignedTags\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.StudioKeyR\x03key\x129\n" +
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12;\n" +
	...
	"created_by\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\tcreatedBy\x12D\n" +
	"\x10last_modified_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x0elastModifiedAt\x12F\n" +
	"\x10last_modified_by\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x0elastModifiedBy\x122\n" +
	"\x05query\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x05query:\x06\xfa\x8d\x19\x02ro\"\xb6\x01\n" +
	"\tInputsKey\x129\n" +
	"\tstudio_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bstudioId\x12?\n" +
	"\fworkspace_id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\vworkspaceId\x12'\n" +
	"\x04path\x18\x03 \x01(\v2\x13.fmp.RepeatedStringR\x04path:\x04\x80\x8e\x19\x01\"\xaf\x01\n" +
	"\fInputsConfig\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.InputsKeyR\x03key\x122\n" +
	"\x06remove\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06remove\x124\n" +
	"\x06inputs\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x06inputs:\x06\xfa\x8d\x19\x02rw\"\xfb\x02\n" +
	"\x06Inputs\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.InputsKeyR\x03key\x129\n" +
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12;\n" +
	"\n" +
	"created_by\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\tcreatedBy\x12D\n" +
	"\x10last_modified_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x0elastModifiedAt\x12F\n" +
	"\x10last_modified_by\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x0elastModifiedBy\x124\n" +
	"\x06inputs\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x06inputs:\x06\xfa\x8d\x19\x02ro\"p\n" +
	"\bTemplate\x122\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1e.arista.studio.v1.TemplateTypeR\x04type\x120\n" +
	"\x04body\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x04body\"Y\n" +
	"\x16BooleanInputFieldProps\x12?\n" +
	"\rdefault_value\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\fdefaultValue\"\xd5\x02\n" +
	"\x16IntegerInputFieldProps\x12@\n" +
	"\rdefault_value\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\fdefaultValue\x129\n" +
	"\x0estatic_options\x18\x02 \x01(\v2\x12.fmp.RepeatedInt64R\rstaticOptions\x122\n" +
	"\x05range\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x05range\x12<\n" +
	"\x0fdynamic_options\x18\x04 \x01(\v2\x13.fmp.RepeatedStringR\x0edynamicOptions\x12L\n" +
	"\x14extra_values_allowed\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x12extraValuesAllowed\"\x9f\x02\n" +
	"\x14FloatInputFieldProps\x12@\n" +
	"\rdefault_value\x18\x02 \x01(\v2\x1b.google.protobuf.FloatValueR\fdefaultValue\x129\n" +
	"\x0estatic_options\x18\x03 \x01(\v2\x12.fmp.RepeatedFloatR\rstaticOptions\x12<\n" +
	"\x0fdynamic_options\x18\x04 \x01(\v2\x13.fmp.RepeatedStringR\x0edynamicOptions\x12L\n" +
	"\x14extra_values_allowed\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x12extraValuesAllowed\"\xff\x03\n" +
	"\x15StringInputFieldProps\x12A\n" +
	"\rdefault_value\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\fdefaultValue\x12:\n" +
	"\x0estatic_options\x18\x03 \x01(\v2\x13.fmp.RepeatedStringR\rstaticOptions\x12<\n" +
	"\x0fdynamic_options\x18\x04 \x01(\v2\x13.fmp.RepeatedStringR\x0edynamicOptions\x124\n" +
	"\x06length\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x06length\x126\n" +
	"\apattern\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\apattern\x124\n" +
	"\x06format\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x06format\x127\n" +
	"\tis_secret\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\bisSecret\x12L\n" +
	"\x14extra_values_allowed\x18\t \x01(\v2\x1a.google.protobuf.BoolValueR\x12extraValuesAllowed\"E\n" +
	"\x14GroupInputFieldProps\x12-\n" +
	"\amembers\x18\x01 \x01(\v2\x13.fmp.RepeatedStringR\amembers\"\x8d\x01\n" +
	"\x19CollectionInputFieldProps\x12@\n" +
	"\rbase_field_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\vbaseFieldId\x12.\n" +
	"\x03key\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x03key\"\x81\x03\n" +
	"\x17ResolverInputFieldProps\x12@\n" +
	"\rbase_field_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\vbaseFieldId\x12M\n" +
	"\fdisplay_mode\x18\x02 \x01(\x0e2*.arista.studio.v1.ResolverFieldDisplayModeR\vdisplayMode\x12G\n" +
	"\n" +
	"input_mode\x18\x03 \x01(\x0e2(.arista.studio.v1.ResolverFieldInputModeR\tinputMode\x12D\n" +
	"\x0finput_tag_label\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\rinputTagLabel\x12F\n" +
	"\x10tag_filter_query\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x0etagFilterQuery\"\xd8\x02\n" +
	"\x19TagMatcherInputFieldProps\x12O\n" +
	"\x10tag_matcher_mode\x18\x01 \x01(\x0e2%.arista.studio.v1.TagMatcherFieldModeR\x0etagMatcherMode\x12H\n" +
	"\x11tag_matcher_label\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x0ftagMatcherLabel\x12F\n" +
	"\x10tag_filter_query\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x0etagFilterQuery\x12X\n" +
	"\x1aresolver_filtering_allowed\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x18resolverFilteringAllowed\"\x9a\b\n" +
	"\n" +
	"InputField\x12,\n" +
	"\x02id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x02id\x124\n" +
	"\x04type\x18\x02 \x01(\x0e2 .arista.studio.v1.InputFieldTypeR\x04type\x120\n" +
	...
	"\brequired\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\brequired\x12M\n" +
	"\rboolean_props\x18\a \x01(\v2(.arista.studio.v1.BooleanInputFieldPropsR\fbooleanProps\x12M\n" +
	"\rinteger_props\x18\b \x01(\v2(.arista.studio.v1.IntegerInputFieldPropsR\fintegerProps\x12G\n" +
	"\vfloat_props\x18\t \x01(\v2&.arista.studio.v1.FloatInputFieldPropsR\n" +
	"floatProps\x12J\n" +
	"\fstring_props\x18\n" +
	" \x01(\v2'.arista.studio.v1.StringInputFieldPropsR\vstringProps\x12G\n" +
	"\vgroup_props\x18\v \x01(\v2&.arista.studio.v1.GroupInputFieldPropsR\n" +
	"groupProps\x12V\n" +
	"\x10collection_props\x18\f \x01(\v2+.arista.studio.v1.CollectionInputFieldPropsR\x0fcollectionProps\x12P\n" +
	"\x0eresolver_props\x18\r \x01(\v2).arista.studio.v1.ResolverInputFieldPropsR\rresolverProps\x12K\n" +
	"\x13auto_fill_action_id\x18\x0e \x01(\v2\x1c.google.protobuf.StringValueR\x10autoFillActionId\x12W\n" +
	"\x11tag_matcher_props\x18\x0f \x01(\v2+.arista.studio.v1.TagMatcherInputFieldPropsR\x0ftagMatcherProps\"\xa9\x01\n" +
	"\vInputFields\x12A\n" +
	"\x06values\x18\x01 \x03(\v2).arista.studio.v1.InputFields.ValuesEntryR\x06values\x1aW\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.arista.studio.v1.InputFieldR\x05value:\x028\x01\"<\n" +
	"\x06Layout\x122\n" +
	"\x05value\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x05value\"v\n" +
	"\vInputSchema\x125\n" +
	"\x06fields\x18\x01 \x01(\v2\x1d.arista.studio.v1.InputFieldsR\x06fields\x120\n" +
	"\x06layout\x18\x02 \x01(\v2\x18.arista.studio.v1.LayoutR\x06layout\"\x81\x01\n" +
	"\vSecretInput\x12-\n" +
	"\x03key\x18\x01 \x01(\v2\x1b.arista.studio.v1.InputsKeyR\x03key\x12;\n" +
	"\n" +
	"plain_text\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\tplainText:\x06\xfa\x8d\x19\x02ro\"\xd9\x01\n" +
	"\x11AutofillActionKey\x129\n" +
	"\tstudio_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bstudioId\x12?\n" +
	"\fworkspace_id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\vworkspaceId\x12B\n" +
	"\x0einput_field_id\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\finputFieldId:\x04\x80\x8e\x19\x01\"\xe0\x02\n" +
	"\x14AutofillActionConfig\x125\n" +
	"\x03key\x18\x01 \x01(\v2#.arista.studio.v1.AutofillActionKeyR\x03key\x122\n" +
	"\x06remove\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06remove\x129\n" +
	"\taction_id\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\bactionId\x12>\n" +
	"\vdescription\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\vdescription\x12Z\n" +
	"\x12argument_providers\x18\x05 \x01(\v2+.arista.studio.v1.AutofillArgumentProvidersR\x11argumentProviders:\x06\xfa\x8d\x19\x02rw\"\xac\x04\n" +
	"\x0eAutofillAction\x125\n" +
	"\x03key\x18\x01 \x01(\v2#.arista.studio.v1.AutofillActionKeyR\x03key\x129\n" +
	"\n" +
	"created_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12;\n" +
	"\n" +
	"created_by\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\tcreatedBy\x12D\n" +
	...
	"\taction_id\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\bactionId\x12>\n" +
	"\vdescription\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\vdescription\x12Z\n" +
	"\x12argument_providers\x18\b \x01(\v2+.arista.studio.v1.AutofillArgumentProvidersR\x11argumentProviders:\x06\xfa\x8d\x19\x02ro\"\xd3\x01\n" +
	"\x19AutofillArgumentProviders\x12O\n" +
	"\x06values\x18\x01 \x03(\v27.arista.studio.v1.AutofillArgumentProviders.ValuesEntryR\x06values\x1ae\n" +
	"\vValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12@\n" +
	"\x05value\x18\x02 \x01(\v2*.arista.studio.v1.AutofillArgumentProviderR\x05value:\x028\x01\"\x8a\x01\n" +
	"\x18AutofillArgumentProvider\x12:\n" +
	"\x04type\x18\x01 \x01(\x0e2&.arista.studio.v1.AutofillProviderTypeR\x04type\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x05value*\x94\x02\n" +
	"\n" +
	"EntityType\x12\x1b\n" +
	...
	" ENTITY_TYPE_CONFIGLET_ASSIGNMENT\x10\a\x12\x1c\n" +
	"\x18ENTITY_TYPE_DEPENDENCIES\x10\b*t\n" +
	...
	"\x19INPUT_FIELD_TYPE_RESOLVER\x10\a\x12 \n" +
	"\x1cINPUT_FIELD_TYPE_TAG_MATCHER\x10\b*\x8b\x02\n" +
	"\x16ResolverFieldInputMode\x12)\n" +
	"%RESOLVER_FIELD_INPUT_MODE_UNSPECIFIED\x10\x00\x12/\n" +
	"+RESOLVER_FIELD_INPUT_MODE_SINGLE_DEVICE_TAG\x10\x01\x122\n" +
	".RESOLVER_FIELD_INPUT_MODE_SINGLE_INTERFACE_TAG\x10\x02\x12.\n" +
	"*RESOLVER_FIELD_INPUT_MODE_MULTI_DEVICE_TAG\x10\x03\x121\n" +
	...
	"\x1dAUTOFILL_PROVIDER_TYPE_LINKED\x10\x03B\xed\x01\xba\x9a\x19\x13repeated-key-fields\n" +
	"\x14com.arista.studio.v1B\vStudioProtoP\x01ZOgithub.com/ioplane/terraform-provider-cvp/internal/pb/arista/studio.v1;studiov1\xa2\x02\x03ASX\xaa\x02\x10Arista.Studio.V1\xca\x02\x10Arista\\Studio\\V1\xe2\x02\x1cArista\\Studio\\V1\\GPBMetadata\xea\x02\x12Arista::Studio::V1b\x06proto3"

var (
	file_arista_studio_v1_studio_proto_rawDescOnce sync.Once
	file_arista_studio_v1_studio_proto_rawDescData []byte
)

func file_arista_studio_v1_studio_proto_rawDescGZIP() []byte {
	file_arista_studio_v1_studio_proto_rawDescOnce.Do(func() {
		file_arista_studio_v1_studio_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_arista_studio_v1_studio_proto_rawDesc), len(file_arista_studio_v1_studio_proto_rawDesc)))
	})
...
var file_arista_studio_v1_studio_proto_goTypes = []any{
...
func file_arista_studio_v1_studio_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_arista_studio_v1_studio_proto_rawDesc), len(file_arista_studio_v1_studio_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   0,
