...
const file_arista_configstatus_v1_configstatus_proto_rawDesc = "" +
	"\n" +
	")arista/configstatus.v1/configstatus.proto\x12\x16arista.configstatus.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x14fmp/extensions.proto\"\x87\x02\n" +
	"\vConfigError\x12@\n" +
	"\n" +
	"error_code\x18\x01 \x01(\x0e2!.arista.configstatus.v1.ErrorCodeR\terrorCode\x129\n" +
	"\terror_msg\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\berrorMsg\x126\n" +
	"\bline_num\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\alineNum\x12C\n" +
	"\x0econfiglet_name\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\rconfigletName\"K\n" +
	"\fConfigErrors\x12;\n" +
	"\x06values\x18\x01 \x03(\v2#.arista.configstatus.v1.ConfigErrorR\x06values\"\x94\x05\n" +
	"\tDiffEntry\x12.\n" +
	"\x02op\x18\x01 \x01(\x0e2\x1e.arista.configstatus.v1.DiffOpR\x02op\x129\n" +
	"\n" +
	"a_line_num\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\baLineNum\x129\n" +
	"\n" +
	"b_line_num\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\bbLineNum\x12F\n" +
	"\x11b_parent_line_num\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\x0ebParentLineNum\x123\n" +
	"\x06a_line\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x05aLine\x123\n" +
	"\x06b_line\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\x05bLine\x12L\n" +
	"\ra_filter_code\x18\a \x01(\x0e2(.arista.configstatus.v1.ConfigFilterCodeR\vaFilterCode\x12L\n" +
	"\rb_filter_code\x18\b \x01(\x0e2(.arista.configstatus.v1.ConfigFilterCodeR\vbFilterCode\x12F\n" +
	"\x11a_parent_line_num\x18\t \x01(\v2\x1b.google.protobuf.Int32ValueR\x0eaParentLineNum\x12K\n" +
	"\x14is_a_default_command\x18\n" +
	" \x01(\v2\x1a.google.protobuf.BoolValueR\x11isADefaultCommand\"H\n" +
	"\vDiffEntries\x129\n" +
	"\x06values\x18\x01 \x03(\v2!.arista.configstatus.v1.DiffEntryR\x06values\"\x94\x01\n" +
	"\fConfigSource\x12I\n" +
	"\vsource_type\x18\x01 \x01(\x0e2(.arista.configstatus.v1.ConfigSourceTypeR\n" +
	"sourceType\x129\n" +
	"\tsource_id\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\bsourceId\"M\n" +
	"\rConfigSources\x12<\n" +
	"\x06values\x18\x01 \x03(\v2$.arista.configstatus.v1.ConfigSourceR\x06values\"\xf0\a\n" +
	"\rConfigSummary\x12:\n" +
	"\x04sync\x18\x01 \x01(\x0e2&.arista.configstatus.v1.ConfigSyncCodeR\x04sync\x128\n" +
	"\tnop_lines\x18\x02 \x01(\v2\x1b.google.protobuf.Int32ValueR\bnopLines\x12@\n" +
	"\rignored_lines\x18\x03 \x01(\v2\x1b.google.protobuf.Int32ValueR\fignoredLines\x12<\n" +
	"\vadded_lines\x18\x04 \x01(\v2\x1b.google.protobuf.Int32ValueR\n" +
	"addedLines\x12@\n" +
	"\rdeleted_lines\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\fdeletedLines\x12@\n" +
	"\rchanged_lines\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\fchangedLines\x12Q\n" +
	"\x16designed_config_errors\x18\a \x01(\v2\x1b.google.protobuf.Int32ValueR\x14designedConfigErrors\x12U\n" +
	"\x18designed_config_warnings\x18\b \x01(\v2\x1b.google.protobuf.Int32ValueR\x16designedConfigWarnings\x12W\n" +
	"\x1arunning_config_update_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x17runningConfigUpdateTime\x12Y\n" +
	"\x1bdesigned_config_update_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x18designedConfigUpdateTime\x12J\n" +
	"\x12running_config_uri\x18\v \x01(\v2\x1c.google.protobuf.StringValueR\x10runningConfigUri\x12L\n" +
	"\x13designed_config_uri\x18\f \x01(\v2\x1c.google.protobuf.StringValueR\x11designedConfigUri\x127\n" +
	"\bdiff_uri\x18\r \x01(\v2\x1c.google.protobuf.StringValueR\adiffUri\x124\n" +
	"\x06digest\x18\x0e \x01(\v2\x1c.google.protobuf.StringValueR\x06digest\"\x84\x01\n" +
	"\tConfigKey\x129\n" +
	"\tdevice_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bdeviceId\x126\n" +
	"\x04type\x18\x02 \x01(\x0e2\".arista.configstatus.v1.ConfigTypeR\x04type:\x04\x80\x8e\x19\x01\"|\n" +
	"\rConfiguration\x123\n" +
	"\x03key\x18\x01 \x01(\v2!.arista.configstatus.v1.ConfigKeyR\x03key\x12.\n" +
	"\x03uri\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x03uri:\x06\xfa\x8d\x19\x02ro\"\xed\x02\n" +
	"\rConfigDiffKey\x12<\n" +
	"\va_device_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\taDeviceId\x129\n" +
	"\x06a_type\x18\x02 \x01(\x0e2\".arista.configstatus.v1.ConfigTypeR\x05aType\x121\n" +
	"\x06a_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x05aTime\x12<\n" +
	"\vb_device_id\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\tbDeviceId\x129\n" +
	"\x06b_type\x18\x05 \x01(\x0e2\".arista.configstatus.v1.ConfigTypeR\x05bType\x121\n" +
	"\x06b_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x05bTime:\x04\x80\x8e\x19\x01\"}\n" +
	"\n" +
	"ConfigDiff\x127\n" +
	"\x03key\x18\x01 \x01(\v2%.arista.configstatus.v1.ConfigDiffKeyR\x03key\x12.\n" +
	"\x03uri\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x03uri:\x06\xfa\x8d\x19\x02ro\"M\n" +
	"\n" +
	"SummaryKey\x129\n" +
	"\tdevice_id\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\bdeviceId:\x04\x80\x8e\x19\x01\"\x88\x01\n" +
	"\aSummary\x124\n" +
	"\x03key\x18\x01 \x01(\v2\".arista.configstatus.v1.SummaryKeyR\x03key\x12?\n" +
	"\asummary\x18\x02 \x01(\v2%.arista.configstatus.v1.ConfigSummaryR\asummary:\x06\xfa\x8d\x19\x02ro\"\x84\x01\n" +
	"\x0fSecurityProfile\x123\n" +
	"\x03key\x18\x01 \x01(\v2!.arista.configstatus.v1.ConfigKeyR\x03key\x124\n" +
	"\x06config\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x06config:\x06\xfa\x8d\x19\x02ro\"\x86\x05\n" +
	...
	"addedLines\x12@\n" +
	"\rdeleted_lines\x18\x05 \x01(\v2\x1b.google.protobuf.Int32ValueR\fdeletedLines\x12@\n" +
	"\rchanged_lines\x18\x06 \x01(\v2\x1b.google.protobuf.Int32ValueR\fchangedLines\x124\n" +
	"\x06digest\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x06digest\x12W\n" +
	"\x1arunning_config_update_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x17runningConfigUpdateTime\x12Y\n" +
	"\x1bdesigned_config_update_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x18designedConfigUpdateTime\"\xae\x01\n" +
	"\x1aSecurityProfileDiffSummary\x124\n" +
	"\x03key\x18\x01 \x01(\v2\".arista.configstatus.v1.SummaryKeyR\x03key\x12R\n" +
	"\asummary\x18\x02 \x01(\v28.arista.configstatus.v1.SecurityProfileComplianceSummaryR\asummary:\x06\xfa\x8d\x19\x02ro\"\x8f\x01\n" +
	"\x13SecurityProfileDiff\x127\n" +
	"\x03key\x18\x01 \x01(\v2%.arista.configstatus.v1.ConfigDiffKeyR\x03key\x127\n" +
	"\x04diff\x18\x02 \x01(\v2#.arista.configstatus.v1.DiffEntriesR\x04diff:\x06\xfa\x8d\x19\x02ro*\xe9\x01\n" +
	"\tErrorCode\x12\x1a\n" +
	"\x16ERROR_CODE_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19ERROR_CODE_DEVICE_WARNING\x10\x01\x12\x1b\n" +
	"\x17ERROR_CODE_DEVICE_ERROR\x10\x02\x12!\n" +
	"\x1dERROR_CODE_UNREACHABLE_DEVICE\x10\x03\x12\"\n" +
	"\x1eERROR_CODE_CONFIG_FILTER_ERROR\x10\x04\x12\x17\n" +
	"\x13ERROR_CODE_INTERNAL\x10\x05\x12$\n" +
	" ERROR_CODE_PROPOSED_CONFIG_CHECK\x10\x06*\x7f\n" +
	"\x06DiffOp\x12\x17\n" +
	"\x13DIFF_OP_UNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vDIFF_OP_NOP\x10\x01\x12\x12\n" +
	"\x0eDIFF_OP_IGNORE\x10\x02\x12\x0f\n" +
	"\vDIFF_OP_ADD\x10\x03\x12\x12\n" +
	"\x0eDIFF_OP_DELETE\x10\x04\x12\x12\n" +
	"\x0eDIFF_OP_CHANGE\x10\x05*\x82\x01\n" +
	"\x10ConfigFilterCode\x12\"\n" +
	"\x1eCONFIG_FILTER_CODE_UNSPECIFIED\x10\x00\x12#\n" +
	"\x1fCONFIG_FILTER_CODE_MANAGED_LINE\x10\x01\x12%\n" +
	"!CONFIG_FILTER_CODE_UNMANAGED_LINE\x10\x02*r\n" +
	"\x0eConfigSyncCode\x12 \n" +
	"\x1cCONFIG_SYNC_CODE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18CONFIG_SYNC_CODE_IN_SYNC\x10\x01\x12 \n" +
	"\x1cCONFIG_SYNC_CODE_OUT_OF_SYNC\x10\x02*\xd4\x01\n" +
	"\x10ConfigSourceType\x12\"\n" +
	"\x1eCONFIG_SOURCE_TYPE_UNSPECIFIED\x10\x00\x125\n" +
	"1CONFIG_SOURCE_TYPE_NETWORK_PROVISIONING_CONFIGLET\x10\x01\x12\x1d\n" +
	"\x19CONFIG_SOURCE_TYPE_STUDIO\x10\x02\x12$\n" +
	" CONFIG_SOURCE_TYPE_STUDIO_STATIC\x10\x03\x12 \n" +
	"\x1cCONFIG_SOURCE_TYPE_HIERARCHY\x10\x05*j\n" +
	"\n" +
	"ConfigType\x12\x1b\n" +
	"\x17CONFIG_TYPE_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aCONFIG_TYPE_RUNNING_CONFIG\x10\x01\x12\x1f\n" +
	"\x1bCONFIG_TYPE_DESIGNED_CONFIG\x10\x02B\x86\x02\n" +
	"\x1acom.arista.configstatus.v1B\x11ConfigstatusProtoP\x01Z[github.com/ioplane/terraform-provider-cvp/internal/pb/arista/configstatus.v1;configstatusv1\xa2\x02\x03ACX\xaa\x02\x16Arista.Configstatus.V1\xca\x02\x16Arista\\Configstatus\\V1\xe2\x02\"Arista\\Configstatus\\V1\\GPBMetadata\xea\x02\x18Arista::Configstatus::V1b\x06proto3"

var (
	file_arista_configstatus_v1_configstatus_proto_rawDescOnce sync.Once
	file_arista_configstatus_v1_configstatus_proto_rawDescData []byte
)
...
func file_arista_configstatus_v1_configstatus_proto_rawDescGZIP() []byte {
	file_arista_configstatus_v1_configstatus_proto_rawDescOnce.Do(func() {
		file_arista_configstatus_v1_configstatus_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_arista_configstatus_v1_configstatus_proto_rawDesc), len(file_arista_configstatus_v1_configstatus_proto_rawDesc)))
	})
...
var file_arista_configstatus_v1_configstatus_proto_goTypes = []any{
...
func file_arista_configstatus_v1_configstatus_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_arista_configstatus_v1_configstatus_proto_rawDesc), len(file_arista_configstatus_v1_configstatus_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
